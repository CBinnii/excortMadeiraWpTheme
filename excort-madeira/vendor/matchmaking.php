...
try {
    ...
    $MostImportant = $_POST['MostImportant'] ?? '';
    $terms = $_POST['terms'] ?? '';
    ...
    $mail->Body = "
        ...
        <p><strong>Which languages are you fluent in?</strong> $languages</p>
        ...
        <p><strong>Most important booking aspects</strong> $MostImportant</p>
    ";
