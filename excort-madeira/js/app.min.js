...
function menuDesktop(){var e=document.getElementById("menu-button-desktop"),t=document.getElementById("navbar-collapse-desktop"),n=document.getElementById("navbar-menu-desktop-pattern"),s=document.getElementById("language-switcher");t.classList.contains("show")?t.classList.remove("show"):t.classList.add("show"),s.classList.contains("d-none")?s.classList.remove("d-none"):s.classList.add("d-none"),n.classList.contains("d-none")?n.classList.remove("d-none"):n.classList.add("d-none"),e.classList.contains("cross")?e.classList.remove("cross"):e.classList.add("cross")}function menuMobile(){var e=document.getElementById("menu-button"),t=document.getElementById("navbar-collapse"),n=document.getElementById("language-switcher");t.classList.contains("show")?t.classList.remove("show"):t.classList.add("show"),n.classList.contains("d-none")?n.classList.remove("d-none"):n.classList.add("d-none"),e.classList.contains("cross")?e.classList.remove("cross"):e.classList.add("cross")}const menuItemsWithChildren=document.querySelectorAll(".menu-item-has-children");menuItemsWithChildren.forEach(function(e){e.addEventListener("click",function(t){const n=t.target.closest("a");if(n&&"#"!==n.getAttribute("href"))return;t.preventDefault(),this.classList.toggle("active")})}),document.addEventListener("click",function(e){const t=e.target,n=document.querySelector(".menu-item-has-children.active");n&&!n.contains(t)&&n.classList.remove("active")});const siteSearch=document.querySelector(".header-site-search.visible-desktop"),siteSearchInput=document.querySelector(".header-site-search-input.visible-desktop"),nav=document.querySelector(".js-nav");siteSearch&&document.addEventListener("click",e=>{e.composedPath().includes(siteSearch)?(siteSearch.classList.add("active"),setTimeout(function(){siteSearchInput&&siteSearchInput.focus()},100)):e.composedPath().includes(nav)||siteSearch.classList.remove("active")});const siteSearchMobile=document.querySelector(".header-site-search.visible-mobile"),siteSearchInputMobile=document.querySelector(".header-site-search-input.visible-mobile"),navMobile=document.querySelector(".js-nav");siteSearchMobile&&document.addEventListener("click",e=>{e.composedPath().includes(siteSearchMobile)?(siteSearchMobile.classList.add("active"),setTimeout(function(){siteSearchInputMobile&&siteSearchInputMobile.focus()},100)):e.composedPath().includes(navMobile)||siteSearchMobile.classList.remove("active")});var swiperHome=new Swiper(".slider-home",{navigation:{nextEl:".swiper-button-next-slider-home",prevEl:".swiper-button-prev-slider-home"},loop:!0,breakpoints:{640:{slidesPerView:1,spaceBetween:16},1024:{slidesPerView:2,spaceBetween:1}},autoplay:{delay:3e3,disableOnInteraction:!0}}),swiperGeneral=new Swiper(".slider-general",{navigation:{nextEl:".swiper-button-next-slider-general",prevEl:".swiper-button-prev-slider-general"}}),swiperTopExcorts=new Swiper(".slider-top-escorts",{navigation:{nextEl:".swiper-button-next-top-escorts",prevEl:".swiper-button-prev-top-escorts"},loop:!0,breakpoints:{240:{slidesPerView:"auto",spaceBetween:2},768:{slidesPerView:4,spaceBetween:2}},preloadImages:!1,lazy:{loadPrevNext:!0,loadOnTransitionStart:!0}}),el=document.querySelector(".slider-top-escorts");el&&!el.classList.contains("swiper-initialized")&&new Swiper(el,{}),window.addEventListener("pageshow",e=>{e.persisted&&document.querySelectorAll(".slider-top-escorts.swiper-initialized").forEach(e=>{e.swiper&&e.swiper.update()})});var swiperTopExcorts=new Swiper(".slider-profile",{navigation:{nextEl:".swiper-button-next-profile",prevEl:".swiper-button-prev-profile"}}),swiperBlog=new Swiper(".slider-blog",{navigation:{nextEl:".swiper-button-next-blog",prevEl:".swiper-button-prev-blog"},slidesPerView:2,spaceBetween:0,grid:{rows:3}}),swiperWhy=new Swiper(".slider-why",{loop:!0,pagination:{el:".swiper-pagination-why",clickable:!0},breakpoints:{640:{slidesPerView:2,spaceBetween:30,effect:"fade"},768:{slidesPerView:2,spaceBetween:30},991:{slidesPerView:4,spaceBetween:30}}}),swiperProfileSlider=new Swiper(".profile-slider",{loop:!0,navigation:{nextEl:".swiper-button-next-profile",prevEl:".swiper-button-prev-profile"}});
