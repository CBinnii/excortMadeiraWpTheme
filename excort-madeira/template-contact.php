                            ...
                            <form id="contactForm">
                                <div class="row mb-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="firstName" name="firstName" placeholder="<?php if (function_exists('pll_current_language') && pll_current_language() === 'pt') : ?>Nome próprio<?php else : ?>First name<?php endif; ?>">
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="lastName" name="lastName" placeholder="<?php if (function_exists('pll_current_language') && pll_current_language() === 'pt') : ?>Último nome<?php else : ?>Last name<?php endif; ?>">
                                    </div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="<?php if (function_exists('pll_current_language') && pll_current_language() === 'pt') : ?>Número de telefone<?php else : ?>Phone Number<?php endif; ?>">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="message" name="message" rows="4" placeholder="<?php if (function_exists('pll_current_language') && pll_current_language() === 'pt') : ?>Como podemos ajudá-lo?<?php else : ?>How can we help you?<?php endif; ?>"></textarea>
                                </div>
